    ...
    return (
        <div className="line py-8 bg-black text-gray-300">
            <div className="line w-[90%] mx-auto md:flex gap-12 ">
                ...
                <div className="line w-[70%] p-8 space-y-4">
                    ...
                    <div className='flex flex-wrap lg:w-full  mx-auto  gap-6 ml-5 '>
                    ...
                    <div className=" line font-semibold gap-1 pt-5 flex flex-wrap">
                        <p>United Kingdom</p>
                        <p>Ireland</p>
